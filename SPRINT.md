...
- [x] Run all tests and report failures — 762 tests pass (32 test files), 0 failures
- [x] Run lint — 0 errors, 13 pre-existing warnings (shadcn fast-refresh, useEffect deps)
- [x] Run build — succeeds (7.89s)
- [x] Code review: edit page properly isolated, spell slot merge logic tested
- [x] Check for unused imports, dead code — DnD5eCharacterForm no longer imported by EditCharacter (still exists for future use)
